...
- Live Framer code file `LgIzFjJ` powers the mounted `/index` instance, with `useCMS=true`, wrapper `view="list"` as the current instance default, and `thumbnailVideoFieldIds="SvOqFqdby"`. The base archive code still lives in `rgAZFOv`.

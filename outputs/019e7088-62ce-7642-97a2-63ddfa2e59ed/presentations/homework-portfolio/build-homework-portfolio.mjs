...
const assets = {
  gaia: {
    hero: rel("case-study-assets/gaia-selected/hero-app-overview.png"),
    logo: rel("case-study-assets/gaia-selected/brand-logo.png"),
    system: rel("case-study-assets/gaia-selected/logo-system.png"),
    typeA: rel("case-study-assets/gaia-selected/type-new-spirit.png"),
    typeB: rel("case-study-assets/gaia-selected/type-neue-haas.png"),
    colorsA: rel("case-study-assets/gaia-selected/color-primary.png"),
    colorsB: rel("case-study-assets/gaia-selected/color-secondary.png"),
    icons: rel("case-study-assets/gaia-selected/iconography.png"),
    uiSplash: rel("case-study-assets/gaia-selected/ui-splash.png"),
    uiFind: rel("case-study-assets/gaia-selected/ui-find-expanded.png"),
    uiLog: rel("case-study-assets/gaia-selected/ui-log-grid.png"),
    uiStory: rel("case-study-assets/gaia-selected/ui-story.png"),
    uiImpact: rel("case-study-assets/gaia-selected/ui-profile-impact.png"),
    appBook: rel("case-study-assets/gaia-selected/application-book.png"),
    appFlag: rel("case-study-assets/gaia-selected/application-flag.png"),
    appBillboard: rel("case-study-assets/gaia-selected/application-billboard.png"),
    processA: rel("case-study-assets/figma-export/gaia-final-deck/contact-sheets/range-01-23.jpg"),
    processB: rel("case-study-assets/figma-export/gaia-final-deck/contact-sheets/range-24-39.jpg"),
    processC: rel("case-study-assets/figma-export/gaia-final-deck/contact-sheets/range-40-52.jpg"),
    videoMap: rel("case-study-assets/gaia-selected/map-demo.mp4"),
    videoIdentify: rel("case-study-assets/gaia-selected/identify-demo.mp4"),
    videoSplash: rel("case-study-assets/gaia-selected/splash-demo.mp4"),
  },
  motion: {
    heroVideo: rel("case-study-assets/current-site/motion-connect-2025/022-motion-connect_1.mp4"),
    horizontal: rel("case-study-assets/current-site/motion-connect-2025/023-motionconnect_horizontalmockup_mini.png"),
    vertical: rel("case-study-assets/current-site/motion-connect-2025/024-motionconnect_verticalmockup_mini.png"),
    eventA: rel("case-study-assets/current-site/motion-connect-2025/025-event-photos-469a1844-edit.png"),
    eventB: rel("case-study-assets/current-site/motion-connect-2025/027-469a1919.png"),
    eventC: rel("case-study-assets/current-site/motion-connect-2025/028-469a1724.png"),
    eventD: rel("case-study-assets/current-site/motion-connect-2025/029-469a1874-edit.png"),
    process: rel("case-study-assets/current-site/motion-connect-2025/030-after-effects-process-video.mp4"),
    social: rel("case-study-assets/current-site/motion-connect-2025/031-social-articavisuals-zoom_1_1.mp4"),
    typeMotion: rel("case-study-assets/current-site/motion-connect-2025/032-monolithic-metallic-text-animation.mp4"),
    screenshot: rel("case-study-assets/current-site/motion-connect-2025/033-screenshot-2026-01-07-at-10.36.35pm.png"),
    clip1: rel("case-study-assets/current-site/motion-connect-2025/001-clip1.mp4"),
    clip4: rel("case-study-assets/current-site/motion-connect-2025/004-clip4.mp4"),
    clip8: rel("case-study-assets/current-site/motion-connect-2025/008-clip8.mp4"),
    slide2: rel("case-study-assets/current-site/motion-connect-2025/011-slide-2_2.mp4"),
  },
  simon: {
    hero: rel("case-study-assets/current-site/simon-schuster/001-s-s-thumbnail-image.png"),
    research: rel("case-study-assets/current-site/simon-schuster/002-research.png"),
    cover: rel("case-study-assets/current-site/simon-schuster/003-simon_and_schuster_cover.png"),
    frame2: rel("case-study-assets/current-site/simon-schuster/004-frame-2.png"),
    frame3: rel("case-study-assets/current-site/simon-schuster/005-frame-3.png"),
    manifestoA: rel("case-study-assets/current-site/simon-schuster/006-brand-manifesto-mockup.png"),
    manifestoB: rel("case-study-assets/current-site/simon-schuster/007-brand-manifesto-mockup.png"),
    logoMotion: rel("case-study-assets/current-site/simon-schuster/008-s-s-logo-animation-2.mp4"),
    layer: rel("case-study-assets/current-site/simon-schuster/009-layer-1.png"),
    authorMarks: rel("case-study-assets/current-site/simon-schuster/010-author-marks.png"),
    bookA: rel("case-study-assets/current-site/simon-schuster/011-cd4-book_0063__dsc4205.jpg"),
    bookB: rel("case-study-assets/current-site/simon-schuster/034-cd4-book_0003__dsc4596.jpg"),
    postcard: rel("case-study-assets/current-site/simon-schuster/081-postcard.png"),
    tape: rel("case-study-assets/current-site/simon-schuster/082-simon-schuster-tape.png"),
    banner: rel("case-study-assets/current-site/simon-schuster/085-simon-schuster-banner.png"),
    hierarchy: rel("case-study-assets/current-site/simon-schuster/089-brand-hierarchy.mp4"),
    divisions: rel("case-study-assets/current-site/simon-schuster/090-division-marks.png"),
    imprints: rel("case-study-assets/current-site/simon-schuster/091-imprint-marks.png"),
    voyager: rel("case-study-assets/current-site/simon-schuster/093-voyager-imprint.png"),
    banned: rel("case-study-assets/current-site/simon-schuster/095-banned-books-posters.png"),
    forbidden: rel("case-study-assets/current-site/simon-schuster/096-uncover-forbidden-stories.png"),
    release: rel("case-study-assets/current-site/simon-schuster/098-book-release-posters.mp4"),
    poster100: rel("case-study-assets/current-site/simon-schuster/099-100-years-poster.png"),
  },
  karuna: {
    hero: rel("case-study-assets/current-site/karuna/001-untitled-1.png"),
    backgroundA: rel("case-study-assets/current-site/karuna/002-background-1.png"),
    backgroundB: rel("case-study-assets/current-site/karuna/003-background-2.png"),
    backgroundC: rel("case-study-assets/current-site/karuna/004-background-3.png"),
    backgroundD: rel("case-study-assets/current-site/karuna/005-background-4.png"),
    wordmark: rel("case-study-assets/current-site/karuna/006-wordmark.png"),
    logomark: rel("case-study-assets/current-site/karuna/007-logomark.png"),
    type: rel("case-study-assets/current-site/karuna/008-typography.png"),
    patterns: rel("case-study-assets/current-site/karuna/009-patterns.png"),
    honeyA: rel("case-study-assets/current-site/karuna/011-honey-2.png"),
    honeyB: rel("case-study-assets/current-site/karuna/012-honey-3.png"),
    candle: rel("case-study-assets/current-site/karuna/015-candle-2.png"),
    wrapA: rel("case-study-assets/current-site/karuna/016-bees-wrap-1.png"),
    wrapB: rel("case-study-assets/current-site/karuna/017-bees-wrap-2.png"),
    wrapC: rel("case-study-assets/current-site/karuna/018-bees-wrap-3.png"),
    photoA: rel("case-study-assets/current-site/karuna/020-_dsc0406-edit-2.jpg"),
    photoB: rel("case-study-assets/current-site/karuna/021-_dsc0443-2.jpg"),
    photoC: rel("case-study-assets/current-site/karuna/026-_dsc0453-edit-4.jpg"),
    photoD: rel("case-study-assets/current-site/karuna/027-_dsc0335-edit-2.jpg"),
    productA: rel("case-study-assets/current-site/karuna/028-untitled-7.png"),
    processVideo: rel("case-study-assets/current-site/karuna/030-img_0581.mov"),
    deviceVideo: rel("case-study-assets/current-site/karuna/031-img_0694-apple-devices-hd-best-quality.m4v"),
    docA: rel("case-study-assets/current-site/karuna/032-img_0587.jpg"),
    docB: rel("case-study-assets/current-site/karuna/033-img_0591.jpg"),
    docC: rel("case-study-assets/current-site/karuna/034-img_0586.jpg"),
  },
  yomo: {
    hero: rel("case-study-assets/current-site/yomo/001-yomo-hero-image-2.jpg"),
    research: rel("case-study-assets/current-site/yomo/002-research.png"),
    persona: rel("case-study-assets/current-site/yomo/003-persona.png"),
    desktopVideo: rel("case-study-assets/current-site/yomo/004-desktop-interaction-1_1.mp4"),
    phoneA: rel("case-study-assets/current-site/yomo/005-yomo-phone-mockup.png"),
    cava: rel("case-study-assets/current-site/yomo/006-cava-flat-phone.png"),
    frame: rel("case-study-assets/current-site/yomo/007-frame-1171276399.png"),
    phoneB: rel("case-study-assets/current-site/yomo/008-yomo-phone-mockup-2.png"),
    eatOut: rel("case-study-assets/current-site/yomo/009-eat-out-flat-phone.png"),
    recipes: rel("case-study-assets/current-site/yomo/010-recipe-list-ui.png"),
    glassesA: rel("case-study-assets/current-site/yomo/011-smart-glasses-1.png"),
    glassesB: rel("case-study-assets/current-site/yomo/012-smart-glasses-2.png"),
    glassesC: rel("case-study-assets/current-site/yomo/013-smart-glasses-3.png"),
    compVideo: rel("case-study-assets/current-site/yomo/014-comp-1.mp4"),
    phoneC: rel("case-study-assets/current-site/yomo/015-phone-mockup-3.png"),
    systemA: rel("case-study-assets/current-site/yomo/016-design-system.png"),
    logo: rel("case-study-assets/current-site/yomo/017-logo.png"),
    type: rel("case-study-assets/current-site/yomo/018-retail-typeface.png"),
    systemB: rel("case-study-assets/current-site/yomo/019-design-system-2.png"),
    scenario: rel("case-study-assets/current-site/yomo/020-scenario.png"),
    structure: rel("case-study-assets/current-site/yomo/021-structure-research.png"),
    wireframes: rel("case-study-assets/current-site/yomo/022-wireframes.png"),
    logoMock: rel("case-study-assets/current-site/yomo/023-yomo-logo-mockup.png"),
    ad: rel("case-study-assets/current-site/yomo/024-yomo-ad.png"),
  },
};
...
async function writePlanningFiles() {
  const sourceNotes = [
    ...
    "- case-study-assets/current-site for current portfolio imagery",
    "- case-study-assets/gaia-selected and figma-export/gaia-final-deck for Gaia source material",
    "",
    "Known constraints:",
